...
uint8_t sendPacketPart1(SPI_HandleTypeDef* spiHandle, uint8_t packet[12]){
	...
	TextOut(smallStrBuffer);
	sprintf(smallStrBuffer, "packet[2] = %i\n", packet[2]);
	TextOut(smallStrBuffer);
	sprintf(smallStrBuffer, "packet[3] = %i\n", packet[3]);
	TextOut(smallStrBuffer);
	sprintf(smallStrBuffer, "packet[4] = %i\n", packet[4]);
	TextOut(smallStrBuffer);
	sprintf(smallStrBuffer, "packet[5] = %i\n", packet[5]);
	TextOut(smallStrBuffer);
	sprintf(smallStrBuffer, "packet[7] = %i\n", packet[6]);
	TextOut(smallStrBuffer);
